...
const MyMapCS1 = () => {
    const specificLocation = {
        latitude: 20.96521308995705,
        longitude: 105.76567397584013,
        latitudeDelta: 0.01,
        longitudeDelta: 0.01,
    };
        ...
        <View style={styles.container}>
            <MapView
                ...
                <Marker
                    ...
                    description="236 Quang Trung, TP.Hà Nội"
                >
                    <Callout>
                        <View style={styles.calloutContainer}>
                            <Text style={styles.calloutTitle}>THẾ GIỚI ĐỒ THỜI TRANG CƠ SỞ 2</Text>
                            <Text style={styles.calloutDescription}>236 Quang Trung, TP.Hà Nội</Text>
                        </View>
                    </Callout>
                </Marker>
            </MapView>
